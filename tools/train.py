...
def main(cfg: DictConfig) -> Path:
    ...
    trainer = animaloc.train.trainers.__dict__[cfg.training_settings.trainer](
        ...
        early_stopping = cfg.training_settings.early_stopping if hasattr(cfg.training_settings, "early_stopping") else False,
        patience = cfg.training_settings.early_stopping_patience if hasattr(cfg.training_settings, "early_stopping_patience") else False,
        )
